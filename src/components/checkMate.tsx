...
export const CheckMate = () => {
  ...
  return (
    <section className="flex gap-8 flex-col justify-center items-center bg-black/80 absolute text-center w-full h-full z-20">
      ...
      <div className="flex p-2 justify-center w-[150px] h-[150px] bg-dark-wood border-2 rounded-lg">
        <King color={turn === "white" ? TURNS.BLACK : TURNS.WHITE} />
      </div>
      <div>
        <button
          className="text-white font-semibold bg-sky-800 hover:bg-sky-900 p-3 border-2 border-black rounded-lg"
          onClick={resetGame}
        >
          Play again
        </button>
