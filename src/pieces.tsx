...
export const Queen = ({ color }: Color) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill={`${color}`}
...
export const Bishop = ({ color }: Color) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill={`${color}`}
...
export const Knight = ({ color }: Color) => {
  return (
    <svg
      className={"w-[90%] h-[90%]"}
      xmlns="http://www.w3.org/2000/svg"
